...
function parsePlanningHTML(html) {
    ...
    timeSlots.forEach((slot, slotIndex) => {
        ...
        // 1. <td><span>LIBRE</span></td> - simple available
        // 2. <td class="reservation-cell"><p>...</p><br/><span>Réservé...</span></td> - reserved
        // We need to match any td that has a span, and extract the last span content
...
async function fetchCourtPlanning(params, options = {}) {
    ...
    const dateStr = `${String(params.whenDay).padStart(2, '0')}/${String(params.whenMonth).padStart(2, '0')}/${params.whenYear}`;
